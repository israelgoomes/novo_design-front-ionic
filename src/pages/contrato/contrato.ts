...
console.log(this.contrato.name)
  ...
  createPdf() {
    ...
    var docDefinition = {
      ...
      , style: "header", margin: [0, 20, 0, 0]},
    
        { text: "Fabiano Gomes da Lapa", style: "subheader" ,margin: [10, 0, 0, 3]},
        { text: "CNPJ: 12.405.428/001-01", style: "subheader", margin: [10, 0, 0, 3]},
        { text: "CPF: 260.590.808-98", style: "subheader", margin: [10, 0, 0, 3] },
        { text: "RG: 28.866.616-1", style: "subheader", margin: [10, 0, 0, 3] },
        { text: "TELS: (13) 98836-3024; (13) 98144-0084.", style: "subheader" },



        { text: "CONTRATO DE PRESTAÇÃO DE SERVIÇOS DE MARCENARIA", style: "header", margin: [0, 20, 0, 20] },

        //--------------------  Dados do cliente ----------------------------------------
        {text: "01 - CONTRATANTE:", style:"titles", margin: [0, 20, 0, 10]},
        {text: `${this.cliente.nome}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},
        {text: `Cep: ${this.cliente.bairro}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},
        {text: `Endereço: ${this.cliente.cep}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},
        {text: `Bairro: ${this.cliente.cidade}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},
        {text: `Cidade: ${this.cliente.tel}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},
        {text: `Telefone: ${this.cliente.endereco}`.toUpperCase(), style: "story", margin: [10, 10, 0, 0]},

        //--------------Dados da empresa -------------------------------------
        {text: "02 - CONTRATADO:", style:"titles", margin: [0, 20, 0, 0]},
        {text: "Marcenaria Nova Design, representada por Fabiano Gomes da Lapa.", style: "story", margin: [10, 10, 0, 0]},
        {text: "Endereço (centro de corte e apoio baixada): Avenida marginal um, 102", style: "story", margin: [10, 10, 0, 0]},
        {text: "Cidade: São vicente/SP", style: "story", margin: [0, 10, 0, 0]},

        //-----------------------Descrição do serviço ------------------------------------------
        {text: "03 - DESCRITIVO:", style:"titles", margin: [0, 20, 0, 0]},
        {text: this.contrato.descritivo, style: "story", margin: [10, 10, 0, 0]},
      
        //------------------------------- Valor Total ------------------------------------------
        {text: "04 - VALOR TOTAL:" , style:"titles", margin: [0, 20, 0, 0]},
        {text: `R$ ${this.contrato.vlTotal}`, style: "story", margin: [10, 10, 0, 0]},
        //------------------------------Prazo de entrega --------------------------------------
        {text: `05 - PRAZO DE ENTREGA:`, style:"titles", margin: [0, 20, 0, 0]},
        {text: `${this.contrato.prEntrega}`, style: "story", margin: [10, 10, 0, 0]},

        //--------------------------------Tratados ------------------------------------
        {text: `06:`, style:"titles", margin: [0, 20, 0, 0]},
        {text: "O CONTRATADO FORNCERÁ AS FERRAMENTAS, METERIAIS E PROFISSIONAIS NECESSÁRIOS PARA A EXECUÇÃO DO SERVIÇO, REPONSABILIZANDO-SE INCLUSIVE DA LIMPEZA QUE FOR NECESSÁRIA.", style: "story", margin: [10, 10, 0, 0]},

         //--------------------------------Tratados ------------------------------------
         {text: "07 - ENCANAMENTO:", style:"titles", margin: [0, 20, 0, 0]},
         {text: "FICA DE RESPONSABILIDADE DO CONTRATANTE FORNECER A PLANTA HIDRÁULICA DO APARTAMENTO DOIS DIAS ANTES DA MONTAGEM DOS MÓVEIS, FICANDO O CONTRATADO ISENTO DE QUAISQUER ÔNUS DECORRENTE DE CANO FURADO.", style: "story", margin: [10, 10, 0, 0]},

          //--------------------------------Tratados ------------------------------------
          {text: "08:", style:"titles", margin: [0, 20, 0, 0]},
          {text: "O CONTRATADO REPONDERÁ POR DANOS QUE RESULTEM DA IMPERÍCIA OU NEGLIGÊNCIA SUA OU DE SEUS EMPREGADOS, SEGUNDO OS PRINCÍPIOS GERAIS DE RESPONSABILIDADE.", style: "story", margin: [10, 10, 0, 0]},

           //--------------------------------Tratados ------------------------------------
           {text: "09:", style:"titles", margin: [0, 20, 0, 0]},
           {text: "AS PARTES ELEGEM O FÓRUM DE SÃO VICENTE/SP, PARA DIRIMIREM QUAISQUER DÚVIDAS DECORRENTES DO PRESENTE COTNRATO.", style: "story", margin: [10, 10, 0, 0]},

            //--------------------------------Tratados ------------------------------------
            {text: "10:", style:"titles", margin: [0, 20, 0, 0]},
            {text: "CONTRATANTE E CONTRATADO CONCORDAM E ESTÃO AJUSTADOS COM TODAS AS NORMAS E CLAÚSULAS ESTIPULADAS NESTE CONTRATO, E ASSIM ASSINAM O PRESENTE TERMO EM DUAS VIAS DE IGUAL TEOR, OS QUAIS PASSAM A TER FORÇA LEGAL ENTRE AS PARTES.", style: "story", margin: [10, 10, 0, 0]},

                 //--------------------------------Tratados ------------------------------------
            {text: "__________________________________________________", style:"assinatura", margin: [0, 20, 0, 0]},
               {text: "Assinatura do contratante", style:"assinatura", margin: [0, 20, 0, 0]},
