...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cadastro_projeto__ = __webpack_require__(481);
    ...
    CadastroProjetoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__cadastro_projeto__["a" /* CadastroProjetoPage */]),
            ],
        })
...
var CadastroProjetoPage = /** @class */ (function () {
    function CadastroProjetoPage(navCtrl, navParams, projetoSrvc, alertSrvc, platform, actionSheetCtrl, cameraSrvc, clientesSrvc, modalCtrl, events) {
    ...
    CadastroProjetoPage.prototype.ngOnInit = function () {
        ...
        this.theme = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_7__app_helpers_configHelper__["a" /* configHelper */].storageKeys.color);
    ...
    CadastroProjetoPage.prototype.enableButton = function () {
    ...
    CadastroProjetoPage.prototype.eventChangeColor = function () {
        var _this = this;
        this.events.subscribe(__WEBPACK_IMPORTED_MODULE_7__app_helpers_configHelper__["a" /* configHelper */].Events.changeColor, function () {
            _this.menuController();
        });
    };
    CadastroProjetoPage.prototype.menuController = function () {
        this.theme = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_7__app_helpers_configHelper__["a" /* configHelper */].storageKeys.color);
        if (this.theme == "#527F76") {
            this.theme = 'primary';
        }
